# system prompt: provide some basic context and descriptions of what we want the output to be
system_prompt = """
...
# For user prompts: write a function to create dynamic prompts based on the specific song title and artist. 
# Includes the questions we want answers for and re-emphasizes the expected structured output 
